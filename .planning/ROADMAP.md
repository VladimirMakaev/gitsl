...
Plans:
- [x] 22-01-PLAN.md - Implement 18 new log flags (display, filter, format, complex)
- [x] 22-02-PLAN.md - E2E tests for all 20 LOG requirements
...
Plans:
- [x] 23-01-PLAN.md - Implement 20 diff/show flags (pass-through, templates, warnings)
- [x] 23-02-PLAN.md - E2E tests for all 20 DIFF/SHOW requirements
...
Plans:
- [x] 24-01-PLAN.md - Extend cmd_status.py and cmd_add.py with new flag support
- [x] 24-02-PLAN.md - E2E tests for all 10 STAT/ADD requirements
...
Plans:
- [x] 26-01-PLAN.md - Extend cmd_stash.py, cmd_switch.py, cmd_restore.py, cmd_checkout.py with flag support
- [x] 26-02-PLAN.md - E2E tests for all 21 stash and checkout/switch/restore requirements
